function UnityProgress (dom) {
	...
	logoImage.src = "Echoes/TemplateData/Logo." + splashStyle + ".png"; 
	logoImage.style.position = "absolute";
	parent.appendChild(logoImage);
	this.logoImage = logoImage;

	var progressFrame = document.createElement("img");
	progressFrame.src = "Echoes/TemplateData/ProgressFrame." + splashStyle + ".png"; 
	...
	progressBarImg.src = "Echoes/TemplateData/ProgressBar." + splashStyle + ".png"; 
