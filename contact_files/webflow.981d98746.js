        ...
        window.tram = function (a) {
            ...
            var I = b.frame = function () {
                ...
                function e(a, b, c) {
                    if (a) {
                        var e = typeof a;
                        if (b || (this.timer && this.timer.destroy(), this.queue = [], this.active = !1), "number" == e && b)return this.timer = new R({duration: a, context: this, complete: h}), void(this.active = !0);
                        if ("string" == e && b) {
                            switch (a) {
                                case"hide":
                                    n.call(this);
                ...
                a.init = function (a) {
                    ...
                    var b, c;
                    for (b in a.values)c = a.values[b], this.current[b] !== c && this.tweens.push(new Q({name: b, from: this.current[b], to: c, duration: a.duration, delay: a.delay, ease: a.ease, autoplay: !1}));
                    this.play()
                }, a.render = function (a) {
...
Webflow.require('ix').init([
    {
        ...
        "value": {
            "style": {"opacity": 0},
            "triggers": [{"type": "load", "preload": true, "stepsA": [{"wait": 1200}, {"opacity": 1, "transition": "opacity 500ms ease 0ms"}], "stepsB": []}, {
                "type": "hover",
                "selector": ".game-name",
                "siblings": true,
                "stepsA": [{"transition": "transform 500ms ease 0ms", "x": "0px", "y": "20px", "z": "0px"}],
                "stepsB": [{"transition": "transform 500ms ease 0ms", "x": "0px", "y": "0px", "z": "0px"}]
            }]
        }
    },
    {
        ...
        "value": {
            ...
            "triggers": [{
                "type": "hover",
                "selector": ".game-name-container",
                "stepsA": [{"opacity": 1, "height": "45px", "transition": "opacity 500ms ease 0ms, height 500ms ease 0ms"}],
                "stepsB": [{"opacity": 0, "height": "0px", "transition": "opacity 500ms ease 0ms, height 500ms ease 0ms"}]
            }, {"type": "click", "stepsA": [], "stepsB": []}]
        }
    },
    {"slug": "cv-hover", "name": "CV Hover", "value": {"style": {}, "triggers": [{"type": "hover", "selector": ".cv-text", "stepsA": [{"opacity": 1, "transition": "opacity 500ms ease 0ms"}], "stepsB": [{"opacity": 0, "transition": "opacity 500ms ease 0ms"}]}]}},
    {
        "slug": "fade-in-move",
        "name": "Fade In + Move",
        "value": {"style": {"opacity": 0, "x": "0px", "y": "20px", "z": "0px"}, "triggers": [{"type": "load", "preload": true, "stepsA": [{"opacity": 1, "transition": "transform 500ms ease 0ms, opacity 1000ms ease 0ms", "x": "0px", "y": "0px", "z": "0px"}], "stepsB": []}]}
    },
    {"slug": "fade-on-load", "name": "Fade On Load", "value": {"style": {"opacity": 0}, "triggers": [{"type": "load", "preload": true, "stepsA": [{"wait": 800}, {"opacity": 1, "transition": "opacity 700ms ease 0ms"}], "stepsB": []}]}},
    {
        "slug": "show-play-icon",
        "name": "Show Play Icon",
        "value": {
            "style": {},
            "triggers": [{"type": "hover", "selector": ".play-button", "stepsA": [{"opacity": 0.5, "transition": "opacity 500ms ease 0ms"}], "stepsB": [{"opacity": 0, "transition": "opacity 500ms ease 0ms"}]}, {
                "type": "click",
                "stepsA": [{"width": "960px", "height": "600px", "transition": "width 500ms ease 0ms, height 500ms ease 0ms"}, {"title": "Hide Game Preview", "display": "none"}],
                "stepsB": []
            }, {"type": "click", "selector": ".unity-web-player", "stepsA": [{"wait": 500}, {"display": "block"}], "stepsB": []}]
        }
    }
]);
